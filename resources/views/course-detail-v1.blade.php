...
<body class="page-sub-page page-course-detail">
    ...
    <div class="wrapper">
        ...
        <div id="page-content">
            <div class="container">
                <header>
                    <h1>How to Find Long-Term Customers</h1>
                </header>
                <div class="row">
                    <!-- Course Image -->
                    <div class="col-md-2">
                                ...
                                <article class="course-detail">
                                    <section id="course-header">
                                        ...
                                        <div class="course-count-down" id="course-count-down">
                                            ...
                                            <a href="register-sign-in.html" class="btn"
                                                id="btn-course-join">Join Course</a>
                                        </div><!-- /.course-count-down -->
                                        <hr>
                                        <figure id="course-summary">
                                            <span class="course-summary" id="course-length"><i
                                                    class="fa fa-calendar-o"></i>7 weeks</span>
                                    ...
                                    <section id="course-brief">
                                        ...
                                        <p>
                                            ...
                                            tristique lectus. Nam blandit odio nisl, ac malesuada lacus fermentum sit
                                            amet. Vestibulum vitae
                                            aliquet felis, ornare feugiat elit. Nulla varius condimentum elit, sed
                                            pulvinar leo sollicitudin vel.
                                        </p>
                                    ...
                                    <section id="course-tabs">
                                        ...
                                        <ul class="nav nav-tabs course-detail-tabs">
                                            <li class="active"><a href="#tab-schedule"
                                        ...
                                        <div class="tab-content course-tab-content">
                                                        ...
                                                        <ul class="schedule-list">
                                                            <li>
                                                                ...
                                                                <div class="details-accordion" data-toggle="collapse"
                                                                    data-target="#detail-1">Details<span
                                                                        class="fa fa-plus-square-o"></span></div>
                                                                <!-- /#detail-1 -->
                                                                <div id="detail-1"
                                                                    ...
                                                                    <div class="inner">
                                                                        ...
                                                                        <p>Nam tristique molestie enim. Vivamus at
                                                                            pharetra eros. Mauris vitae eros vitae
                                                                            ligula accumsan vestibulum.
                                                                            Duis sed fermentum lacus
                                                                        </p>
                                                                        <hr>
                                                                        <strong>Video Preview</strong>
                                                                        <iframe src="//player.vimeo.com/video/64373696"
                                                                ...
                                                                <p class="description">
                                                                    In order for a business to grow, the entrepreneur
                                                                    must grow.
                                                                    First, the entrepreneur’s role will evolve from
                                                                    primarily being
                                                                    a “doer” to a manager then to a leader and
                                                                    ultimately to being a
                                                                    coach/mentor.
                                                                </p>
                                                            </li>
                                                            <li>
                                                                ...
                                                                <div class="details-accordion" data-toggle="collapse"
                                                                    data-target="#detail-2">Details<span
                                                                        class="fa fa-plus-square-o"></span></div>
                                                                <!-- /#detail-2 -->
                                                                <div id="detail-2"
                                                                    class="collapse details-accordion-content">
                                                    ...
                                                    <article class="course-schedule-block">
                                                        ...
                                                        <ul class="schedule-list">
                                                            <li>
                                                                ...
                                                                <div class="details-accordion" data-toggle="collapse"
                                                                    data-target="#detail-3">Details<span
                                                                        class="fa fa-plus-square-o"></span></div>
                                                                <!-- /#detail-3 -->
                                                                <div id="detail-3"
                                                                    class="collapse details-accordion-content">
                                                                ...
                                                                <p class="description">
                                                                    Using the Leaders Bank and Trilogy Health Services
                                                                    stories we
                                                                    will look at how two businesses put in place people
                                                                    policies,
                                                                    practices, and a leadership model that led to high
                                                                    employee
                                                                    engagement, loyalty, and productivity that drove
                                                                    high customer
                                                                    satisfaction.
                                                                </p>
                                                            </li>
                                            ...
                                            <div class="tab-pane fade" id="tab-speakers">
                                                <section id="course-speakers">
                                                    <div class="author-block course-speaker">
                                                        <a href="member-detail.html">
                                                            <figure class="author-picture"><img
                                                                    src="assets/img/student-testimonial.jpg" alt="">
                                                            </figure>
                                                        </a>
                                                        <article class="paragraph-wrapper">
                                                            <div class="inner">
                                                                ...
                                                                <p>
                                                                    Morbi nec nisi ante. Quisque lacus ligula, iaculis
                                                                    in elit et, interdum semper quam. Fusce in interdum
                                                                    tortor.
                                                    ...
                                                    <div class="author-block course-speaker">
                                                        <a href="member-detail.html">
                                                            <figure class="author-picture"><img
                                                                    src="assets/img/discussion-author-02.jpg" alt="">
                                                            </figure>
                                                        </a>
                                                        <article class="paragraph-wrapper">
                                                            <div class="inner">
                                                    ...
                                                    <div class="author-block course-speaker">
                                                        <a href="member-detail.html">
                                                            <figure class="author-picture"><img
                                                                    src="assets/img/discussion-author-03.jpg" alt="">
                                                            </figure>
                                                        </a>
                                                        <article class="paragraph-wrapper">
                                                            <div class="inner">
                                            ...
                                            <div class="tab-pane fade" id="tab-gallery">
                                                <ul class="gallery-list">
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-01.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-02.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-03.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-04.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-05.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-06.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-07.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-08.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-09.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-10.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-11.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-12.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-13.jpg"
                                                                alt=""></a></li>
                                                    <li><a href="assets/img/gallery-big-image.jpg"
                                                            class="image-popup"><img src="assets/img/image-14.jpg"
                                                                alt=""></a></li>
                                                </ul>
                                            </div>
                                                ...
                                                <ul class="faq-list">
                                                    ...
                                                    <li>
                                                        <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Nulla et nibh at diam?</h5>
                                                        <p class="description">
                                                            Aliquam sed fermentum nulla. Praesent dictum, velit in
                                                            condimentum volutpat,
                                                            nulla orci vestibulum risus, et facilisis purus urna non
                                                            metus. Donec aliquam
                                                    ...
                                                    <li>
                                                        ...
                                                        <p class="description">
                                                            ...
                                                            vehicula. Vivamus suscipit hendrerit arcu. Nullam lacinia
                                                            purus at porttitor
                                                    ...
                                                    <!-- Question -->
                                                    <li>
                                                        <h5>Vivamus ac risus cursus, eleifend lorem quis, viverra urna.?
                                                        </h5>
                                                        <p class="description">
                                                            Aenean porttitor feugiat nibh. Phasellus et dolor id nulla
                                                            dictum lacinia
                                                            nec bibendum arcu. Vestibulum ante ipsum primis in faucibus
                                                            orci luctus
                                                    ...
                                                    <!-- Question -->
                                                    <li>
                                                        <h5>Hasellus non nisl et quam tristique placerat. Aliquam
                                                            elementum tempus ?</h5>
                                                        <p class="description">
                                                            Pellentesque a luctus libero. Integer mattis diam sem, nec
                                                            ornare neque
                                                            consequat id. Nullam malesuada lacus in rhoncus
                                                            pellentesque. Mauris risus
                                                            mauris, commodo ac volutpat eget, lacinia a risus. Aliquam
                                                            nec semper libero,
                                                            ac pharetra libero.
                                                        </p>
                                                    </li>
                                    ...
                                    <section id="course-info">
                                        ...
                                        <p>
                                            Maecenas sodales, nisl eget dignissim molestie, ligula est consectetur
                                            metus, et mollis justo urna
                                            sit amet nulla. Etiam lectus arcu, pellentesque eu tellus tempor, tristique
                                            ultrices leo. Nullam at
                                            felis mauris. Aenean in neque eu ligula tempor ornare. Mauris tristique in
                                            elit a blandit. Nam laoreet
                                            vulputate nisi eu accumsan. Sed faucibus arcu nec est facilisis dignissim.
                                            Fusce risus leo, euismod ut
                                            cursus vitae, imperdiet id quam. Pellentesque habitant morbi tristique
                                        ...
                                        <p>
                                            Ut dignissim placerat est, sit amet tincidunt enim. Sed nisi nisi, ornare
                                            vitae lacinia a, mattis quis tortor.
                                            Suspendisse ornare adipiscing nunc, sit amet aliquam diam condimentum quis.
                                            Sed in leo sit amet sapien
                                    ...
                                    <section id="presentation">
                                        ...
                                        <div class="presentation" style="width: 100%">
                                            <a class="pdf-object" href="assets/pdf/presentation.pdf"
                                    ...
                                    <section id="learning-material">
                                        ...
                                        <article class="learning-material">
                                            <figure class="learning-material-picture"><img src="assets/img/book-01.jpg"
                                                    alt=""></figure>
                                            <div class="learning-material-description">
                                                <h4>1000 Chairs</h4>
                                                <figure>Charlotte & Peter Fiell</figure>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eu
                                                    lacus ut ipsum laoreet laoreet.
                                                    Nam sollicitudin porta ornare.
                                                </p>
                                            </div>
                                        </article><!-- /.learning-material -->
                                        <article class="learning-material">
                                            <figure class="learning-material-picture"><img src="assets/img/book-02.jpg"
                                                    alt=""></figure>
                                            <div class="learning-material-description">
                                        ...
                                        <div class="section-content">
                                            <div class="logos">
                                                <div class="logo"><a href=""><img
                                                            src="assets/img/logo-partner-01.png" alt=""></a></div>
                                                <div class="logo"><a href=""><img
                                                            src="assets/img/logo-partner-02.png" alt=""></a></div>
                                                <div class="logo"><a href=""><img
                                                            src="assets/img/logo-partner-03.png" alt=""></a></div>
                                                <div class="logo"><a href=""><img
                                                            src="assets/img/logo-partner-04.png" alt=""></a></div>
                                            </div>
                                        </div>
                                    </section><!-- /#sponsors -->
                                    ...
                                    <section id="comments">
                                        ...
                                        <ul class="discussion-list">
                                            <li class="author-block">
                                                <figure class="author-picture"><img
                                                        src="assets/img/student-testimonial.jpg"></figure>
                                                <article class="paragraph-wrapper">
                                                    <div class="inner">
                                                        <header>
                                            ...
                                            <li>
                                                <ul class="discussion-child">
                                                    <li class="author-block">
                                                        <figure class="author-picture"><img
                                                                src="assets/img/discussion-author-03.jpg"></figure>
                                                        <article class="paragraph-wrapper">
                                                            <div class="inner">
                                                                <header>
                                                                    <h5>John Doe</h5>
                                                            ...
                                                            <li class="author-block">
                                                                ...
                                                                <article class="paragraph-wrapper">
                                                                    <div class="inner">
                                                                        ...
                                                                        <div class="rating-individual" data-score="4">
                                                                        </div>
                                                                        <p>
                                                                            Mauris elementum et libero ac pharetra.
                                                                            Proin tristique dapibus tellus,
                                                                            lacinia blandit mi tincidunt at. Vivamus
                                                                            vitae interdum felis.
                                                                            Pellentesque congue mollis erat in
                                                                            imperdiet.
                                                                        </p>
                                                                    </div>
                                                                    <div class="comment-controls">
                                            ...
                                            <li class="author-block">
                                                <figure class="author-picture"><img
                                                        src="assets/img/discussion-author-02.jpg"></figure>
                                                <article class="paragraph-wrapper">
                                                    <div class="inner">
                                                        <header>
                                                            <h5>Jane Mason</h5>
                        ...
                        <div id="page-sidebar" class="sidebar">
                            <aside id="related-courses">
                                ...
                                <article class="course-thumbnail small">
                                    <figure class="image">
                                        <div class="image-wrapper"><a href="course-detail-v1.html"><img
                                                    src="assets/img/course-01.jpg"></a></div>
                                    </figure>
                                    <div class="description">
                                        <a href="course-detail-v1.html">
                                            <h3>Architecture Photography: Power of Light and Shadows</h3>
                                        </a>
                                ...
                                <article class="course-thumbnail small">
                                    <figure class="image">
                                        <div class="image-wrapper"><a href="course-detail-v1.html"><img
                                                    src="assets/img/event-img-01.jpg"></a></div>
                                    </figure>
                                    <div class="description">
                                        <a href="course-detail-v1.html">
                                            <h3>Character Drawing: Basic and Advanced Principles</h3>
                                        </a>
                                ...
                                <article class="course-thumbnail small">
                                    <figure class="image">
                                        <div class="image-wrapper"><a href="course-detail-v1.html"><img
                                                    src="assets/img/event-img-02.jpg"></a></div>
                                    </figure>
                                    <div class="description">
                                        <a href="course-detail-v1.html">
                                            <h3>How to find long term customers</h3>
                                        </a>
                                        <a href="#" class="course-category">Photography</a>
                                        <hr>
                                        <div class="course-meta">
                            ...
                            <aside class="news-small" id="news-small">
                                ...
                                <div class="section-content">
                                    <article>
                                        <figure class="date"><i class="fa fa-file-o"></i>08-24-2014
                                        </figure>
                                        <header><a href="#">U-M School of Public Health, Detroit partners aim to improve
                                                air quality in the city</a></header>
                                    </article><!-- /article -->
                                    <article>
                                        <figure class="date"><i class="fa fa-file-o"></i>08-24-2014
                                        </figure>
        ...
        <footer id="page-footer">
            ...
            <section id="footer-content">
                ...
                <div class="background"><img src="assets/img/background-city.png" class="" alt="">
                </div>
